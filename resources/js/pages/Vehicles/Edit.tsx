...
import { type Driver, type Vehicle, type VehicleCategory } from '@/types/vehicle';
...
export default function Edit({ vehicle, categories, drivers }: Props) {
    ...
    const form = useForm<z.infer<typeof formSchema>>({
        ...
        defaultValues: {
            ...
            make: vehicle.make,
            color: vehicle.color,
            driver_id: vehicle.driver_id ? vehicle.driver_id.toString() : '0',
        },
    });
    ...
    function onSubmit(values: z.infer<typeof formSchema>) {
        ...
        router.put(route('vehicles.update', vehicle.id), formattedValues, {
            onSuccess: () => {
