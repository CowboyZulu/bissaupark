...
export default function Create({ zones, vehicleCategories }: CreateProps) {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        {
            title: 'Create',
            href: route('parking-rates.create')
        }
    ];

    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('parking-rates.store'), {
            onSuccess: () => {
                toast.success('Parking rate created successfully');
            },
            onError: (errors) => {
                console.error(errors);
                toast.error('Failed to create parking rate');
            }
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Create Parking Rate" />
                ...
                <div className="max-w-3xl mx-auto w-full">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Add a new parking rate for a specific zone and vehicle category
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
